...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | AllertaMeteoAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page AllertaMeteoAdmin Dashboard Template",
  // other metadata
};
