...
export const metadata: Metadata = {
  title: "Next.js SignIn Page | AllertaMeteoAdmin - Next.js Dashboard Template",
  description: "This is Next.js Signin Page AllertaMeteoAdmin Dashboard Template",
};
