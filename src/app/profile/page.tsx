...
export const metadata: Metadata = {
  title: "Next.js Profile | AllertaMeteoAdmin - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for AllertaMeteoAdmin - Next.js Tailwind CSS Admin Dashboard Template",
};
